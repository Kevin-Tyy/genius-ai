  ...
  return (
    <div className="flex justify-center px-2 md:px-0">
      <div className={`relative w-full md:h-[764px] rounded-xl overflow-hidden`}>
        <Image src={image} alt="" width={1400} height={1400} className="rounded-t-[30px] w-full h-[338px] object-cover" />
        <div className="relative -top-14 w-full rounded-[30px] bg-gradient-to-tr from-[#171b27] via-[#11141dc2] to-[#1a1d2b59] backdrop-blur-3xl card-border-gradients p-6 min-[400px]:p-10 space-y-6">
