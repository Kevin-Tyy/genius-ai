    ...
    <div className="flex justify-center">
      <div className="w-full md:w-[80%] lg:w-[60%] xl:w-[50%]">
        ...
        <div className="overflow-hidden mt-5 md:mt-10">
          <table className="table-auto w-full md:w-full h-auto md:h-[40vh] border-collapse border border-gray-300">
            <colgroup>
              <col className="w-10" />
                ...
                <td className="border border-gray-300 px-4 py-2">
                  ...
                  {isExpanded && (
                    <p className="mt-2 md:mt-4 text-sm md:text-base">
                      ...
                      conversational dialogue. The language model can respond
                      to questions and compose various written content,
