  ...
  return (
    <div className="px-3 md:px-12 mt-20">
      <div className="w-full max-w-[1560px] mx-auto h-full ">
        <div className="relative w-full flex justify-center items-center rounded-3xl mx-auto bg-gradient-to-br from-[#313a5b54] to-[#313a5b00] border-2 border-[#5c6a9e30] px-10 py-20">
          ...
          <div className="w-full">
            ...
            <form className="w-full">
              <div className="bg-gradient-to-r from-[#11101800] to-[#00000080] flex w-full max-w-3xl mx-auto flex-row px-6 py-4 justify-between gap-2 items-center mt-12 border-top-gradient border-top-gradient-dark rounded-3xl">
                ...
                <button className="w-full max-w-[216px] shadow-lg shadow-black gradient-border py-4 px-4 rounded-xl space-x-3 flex items-center justify-center button-gradient-sm">
